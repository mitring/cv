...
\cvitem{Языки}{\textbf{Java}, \textbf{Python}, \textbf{SQL},  Groovy, JavaScript, PHP, C, Delphi, \textit{Scala}, \textit{Kotlin}}
...
\cvitem{CI/CD}{\textbf{Kubernetes}, OpenShift, \textbf{Jenkins}, TeamCity, Concourse, \textbf{Docker}, Artifactory, \textbf{Nexus OSS}}
