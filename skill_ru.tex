...
\cvitem{FTS}{ElasticSearch, Sphinx}
\cvitem{Streams}{\textbf{Kafka}}
\cvitem{Big Data}{\textbf{Flink}, \textbf{Hadoop}, \textbf{Hive}, \textbf{Spark}, \textbf{Airflow}}
\cvitem{Servers}{Tomcat, Nginx, Weblogic, Apache HTTP Server}
\cvitem{VCS}{\textbf{Git}, Subversion}
\cvitem{Build}{\textbf{Gradle}, \textbf{Maven}}
\cvitem{CI/CD}{\textbf{Kubernetes}, \textbf{OpenShift}, \textbf{TeamCity}, Jenkins, \textbf{Concourse}, \textbf{Docker}, Artifactory, \textbf{Nexus OSS}}
